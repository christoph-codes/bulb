...
const Apis = ({ props }) => {
  const { loginWithEmailAndPassword, createAccount, user, error } = useAuth();
      ...
      <div className={styles.Api__cards}>
        <article className={styles.Api__cards__card}>
          ...
          <input
            ...
            onChange={(e) => update(e, loginFormInputs, setLoginFormInputs)}
            onBlur={(e) => validate(e)}
          />
          <input
            type="password"
      ...
      <div className={styles.Api__cards}>
        <article className={styles.Api__cards__card}>
          ...
          <input
            ...
            onChange={(e) =>
              update(e, createAccountFormInputs, setCreateAccountFormInputs)
            }
            onBlur={(e) => validate(e)}
          />
          <input
      ...
      <div className={styles.Api__cards}>
        <article className={styles.Api__cards__card}>
          ...
          <input
            ...
            onChange={(e) =>
              update(e, updateAccountFormInputs, setUpdateAccountFormInputs)
            }
            onBlur={(e) => validate(e)}
          />
          <input
